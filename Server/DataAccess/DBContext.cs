...
public partial class DBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Board>(entity =>
        {
            ...
            entity.HasIndex(e => e.GameId, "IX_boards_game_id");

            entity.HasIndex(e => e.PlayerId, "IX_boards_player_id");

            entity.HasIndex(e => new { e.PlayerId, e.GameId, e.Numbers }, "unique_board_numbers").IsUnique();
        ...
        modelBuilder.Entity<Transaction>(entity =>
        {
            ...
            entity.HasIndex(e => e.PlayerId, "IX_transactions_player_id");
        ...
        modelBuilder.Entity<Winner>(entity =>
        {
            ...
            entity.HasIndex(e => e.BoardId, "IX_winners_board_id");

            entity.HasIndex(e => e.GameId, "IX_winners_game_id");
